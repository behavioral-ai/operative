...
func newThreshold(version int, resolver collective.Resolution) (threshold, *messaging.Status) {
	return collective.Resolve[threshold](urn.ResiliencyThreshold, version, resolver)
}
